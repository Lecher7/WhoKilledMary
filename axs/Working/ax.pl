...
my %Maps = (
	'http://whokilledmary.com/'     => 'http://www.xav.com/',
	'http://ftp.whokilledmary.com/' => 'http://www.xav.com/',
	);
...
# it as well):
#
####	my $TransURL = 'http://www.xav.com/scripts/axs/trans.gif';
my $TransURL = '';
...
<HTML>
<HEAD>
	<TITLE>AXS Remote Debugger</TITLE>
...
<BODY>
<P>Read the <A HREF="http://www.xav.com/scripts/axs/" TARGET="_blank">trouble-shooting guide</A> if you need more help.</P>
<DL>
...
<SMALL>
	AXS Script Set Version $VERSION is copyright 1997-2001 by <A HREF="http://www.xav.com/">Fluid Dynamics</A>.<BR>
	Visit the <A HREF="http://www.xav.com/scripts/axs/">AXS Page</A> for help files and most recent version.
</SMALL>
