...
%LocalAddressTitlePairs = (
	...
	'http://www.whokilledmary.com/scripts/axs/' , 'AXS Script Page',
	);
...
%GraphOptions = (
	...
	's05' => 'Visitor 1-level Domain (xav.com)',
	's06' => 'Visitor Full (dialup-123.xav.com)',
...
<TT>AXS</TT> keeps records on visits to your site. This companion script, <TT>AX-ADMIN</TT>, allows you to display these records in meaningful graph and database formats.  We currently have <B>$cur_hits</B> hits to work with.
...
<INPUT TYPE="submit" VALUE="View in Graphical Format" NAME="MakeGraphs" ONCLICK="JavaMakeGraphs()"><BR>
	<IMG SRC="$PREF{'images_folder'}tracker.jpg" ALT="AXS logo" HEIGHT="205" WIDTH="198">
</TD>
</TR>
</TABLE>
</CENTER>
...
<P>Because you'll typically generate the same graphs repeatedly, <TT>AXS</TT> allows you to specify default settings. Enter your most common settings below. Later, <TT>AX-ADMIN</TT> will select these values automatically.</P>
...
<BLOCKQUOTE>
	...
	<P>By default, <TT>AXS</TT> will graph all hits in the database. However, with these filters, you can restrict graphs to recent hits, critical files, or both.</P>
...
<DD>http://www.xav.com/links.html#localsites<I>
becomes</I><BR>http://www.xav.com/links.html<BR></DD>
...
<DD>http://www.xav.com/links.cgi?foo=bar<I>
becomes</I><BR>http://www.xav.com/links.cgi<BR></DD>
...
<DD>http://www.xav.com/$DefaultDoc<I>
becomes</I><BR>http://www.xav.com/</DD>
...
You can use http://www.xav.com/images/ if you want. There is no guarantee that the images will always be hosted there, so it is best if you can host the images on your own server.</P>
...
<P>This script is operated by <A HREF="mailto:$Admin_Email_Address">$Admin_Email_Address</A>, or a third party reachable via that address. Contact them for help with usernames and passwords. Technical issues, bug reports, and the like may be directed to <A HREF="mailto:noc\@xav.com"><FONT SIZE="-1">noc\@xav.com</FONT></A>.</P>
