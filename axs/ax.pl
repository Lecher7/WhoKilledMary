...
EyeSoft Script Set, Logging Module
...
# be addressed as http://aftk.com/ and http://www.aftk.com/ then this set of
...
my %Maps = (
	'http://whokilledmary.com/'     => 'http://www.aftk.com/',
	'http://ftp.whokilledmary.com/' => 'http://www.aftk.com/',
	);
...
#
	my $domain = 'http://24.44.161.154:8000';
#
...
# it as well):
#
####	my $TransURL = 'http://www.aftk.com/scripts/axs/trans.gif';
my $TransURL = '';
...
<HTML>
<HEAD>
	<TITLE>EyeSoft Remote Debugger</TITLE>
...
<BODY>
<P>Read the <A HREF="http://www.aftk.com/scripts/eyesoft/" TARGET="_blank">trouble-shooting guide</A> if you need more help.</P>
<DL>
...
<DD>
	...
	<OL>
		...
		<LI>
			<P>Add the "EyeSoft tracking code" to any HTML pages that you want to have tracked.</P>
...
\t&lt;/NOSCRIPT&gt;
		...
		<LI>
			<P>Code your <I>off-site</I> links like this (links to pages/files that don't already contain the EyeSoft tracking code):</P>
...
<DD>
<P>This is EyeSoft Logging Module version $VERSION in debug mode.<BR>
...
<SMALL>
	EyeSite Script Set Version $VERSION is copyright 1997-2001 by <A HREF="http://www.aftk.com/">Eye Software Solutions</A>.<BR>
	Visit the <A HREF="http://www.aftk.com/scripts/eyesite/">EyeSite Page</A> for help files and most recent version.
</SMALL>
